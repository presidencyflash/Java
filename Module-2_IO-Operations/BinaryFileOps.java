...
public class BinaryFileOps {
    ...
    public static void addRecords(String filepath) throws Exception {
        Scanner sc = new Scanner(System.in);
        FileOutputStream output = new FileOutputStream(filepath, true); // append mode
        char ch = 'n';
        do {
            ...
            System.out.println("Enter y to add more students, n to stop:");
            ch = sc.next().charAt(0);
        } while (ch != 'n');
    ...
    public static void main(String[] args) throws Exception {
        // Change folder/file names as needed
        String folder = "4cse";
